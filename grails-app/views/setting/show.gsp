...
<html>
    ...
    <body>
        ...
        <div id="show-setting" class="content scaffold-show" role="main">
            ...
            <f:display bean="setting" />
            <g:form resource="${this.setting}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.setting}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
