...
<html>
    ...
    <body>
        ...
        <div id="edit-setting" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.setting}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.setting}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.setting}" method="PUT">
                <g:hiddenField name="version" value="${this.setting?.version}" />
                <fieldset class="form">
                    <f:all bean="setting"/>
                </fieldset>
